...
export const en: Textos = {
  ...
  splash: {
    ...
    proofSinOpinionDetalle: 'no tonal-character judgments, no brand-synergy claims',
    version: 'V20.08.26',
    ...
    recomendadoNotaSala:
      "Evaluated in a reference room, not yours. The Room group stays at a warning because of a limit in the model itself (the floor reflection always lands on an audible frequency, no matter the room), not this specific system.",
