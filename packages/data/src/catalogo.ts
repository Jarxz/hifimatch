    ...
    },
{
  ...
  },
  {
    id: 'audiovector-qr3',
    marca: 'Audiovector',
    nombre: 'Audiovector QR3',
    tipo: { es: 'Columna de 2,5 vías, bass reflex, tweeter AMT', en: '2.5-way floorstander, bass reflex, AMT tweeter' },
    descripcion: {
      es: 'Columna danesa de 2,5 vías con tweeter AMT (Air Motion Transformer) y dos woofers de 15 cm. La ficha oficial declara la impedancia como un rango "4-8 Ω" en vez de un nominal único — se registra el extremo más bajo (4 Ω), el criterio conservador, en vez de asumir 8 Ω.',
      en: 'A Danish 2.5-way floorstander with an AMT (Air Motion Transformer) tweeter and two 15 cm woofers. The official spec sheet declares impedance as a "4-8 Ω" range rather than a single nominal figure — the lower end (4 Ω) is registered, the conservative choice, instead of assuming 8 Ω.',
    },
    sensibilidadDb: {
      valor: 90,
      fuente: { es: 'Audiovector (ficha oficial)', en: 'Audiovector (official spec sheet)' },
      confianza: 'alta',
      nota: { es: 'la ficha declara explícitamente "90dB (2.83V, 1m)"', en: 'the spec sheet explicitly states "90dB (2.83V, 1m)"' },
    },
    sensibilidadConvencion: '2.83V',
    impedanciaNominalOhm: 4,
    impedanciaMinOhm: null,
    ...
    potenciaRecMaxW: null,
    maxSplDb: null,
    chipsExtra: [{ es: 'tweeter AMT', en: 'AMT tweeter' }],
    fuentes: ['Audiovector (ficha oficial, audiovector.com)', 'Hi-Fi+ (reseña técnica)'],
    pendiente: {
      es: 'la ficha declara "4-8 Ω" como impedancia (no un nominal único) — se usa el extremo bajo por conservador; no se encontró una impedancia mínima real medida. El fabricante da "200 W (music)" como manejo de potencia, no un rango de potencia recomendada de amplificador — mismo criterio ya aplicado a fuentes Yamaha de este catálogo: se deja potenciaRecMinW/MaxW en null en vez de asumir la equivalencia',
      en: 'the spec sheet declares "4-8 Ω" as impedance (not a single nominal figure) — the low end is used as the conservative choice; no real measured minimum impedance was found. The manufacturer gives "200 W (music)" as power handling, not a recommended amplifier power range — same criterion already applied to this catalog\'s Yamaha sources: potenciaRecMinW/MaxW are left null instead of assuming the equivalence',
    },
  },
  {
    id: 'martin-logan-electromotion-esl-x',
    marca: 'MartinLogan',
    nombre: 'MartinLogan ElectroMotion ESL X',
    tipo: {
      es: 'Híbrido electrostático, panel de agudos/medios + woofer dinámico de 20 cm',
      en: 'Electrostatic hybrid, electrostatic panel for mid/high + 20 cm dynamic woofer',
    },
    descripcion: {
      es: 'Híbrido electrostático: panel curvo de 292 pulgadas² cubre medios/agudos sin filtro convencional, cruzando a 500 Hz con un woofer dinámico de 20 cm. Los paneles electrostáticos tienen curvas de impedancia muy reactivas en agudos — la ficha oficial declara un mínimo de 1,6 Ω a 20 kHz; una medición independiente (HT Labs) dio un mínimo algo más alto, 2,03 Ω a 17,2 kHz. Se registra la cifra oficial por ser la más exigente de las dos (criterio conservador).',
      en: 'An electrostatic hybrid: a curved 292 sq. in. panel covers mid/high frequencies with no conventional filter, crossing at 500 Hz to a 20 cm dynamic woofer. Electrostatic panels have very reactive impedance curves at high frequencies — the official spec sheet declares a minimum of 1.6 Ω at 20 kHz; an independent measurement (HT Labs) found a somewhat higher minimum, 2.03 Ω at 17.2 kHz. The official figure is registered as the more demanding of the two (the conservative choice).',
    },
    sensibilidadDb: {
      valor: 91,
      fuente: { es: 'MartinLogan (ficha oficial)', en: 'MartinLogan (official spec sheet)' },
      confianza: 'alta',
      nota: { es: 'la ficha declara explícitamente "91 dB/2,83 V/m" (formato "volts/meter" en el original)', en: 'the spec sheet explicitly states "91 dB/2.83 volts/meter"' },
    },
    sensibilidadConvencion: '2.83V',
    impedanciaNominalOhm: 6,
    impedanciaMinOhm: 1.6,
    impedanciaMaxOhm: null,
    anguloFaseGrados: null,
    potenciaRecMinW: 20,
    potenciaRecMaxW: 400,
    maxSplDb: null,
    chipsExtra: [
      { es: 'panel electrostático (medios/agudos)', en: 'electrostatic panel (mid/high)' },
      { es: 'mín. medido (HT Labs): 2,03 Ω a 17,2 kHz', en: 'measured min. (HT Labs): 2.03 Ω at 17.2 kHz' },
    ],
    fuentes: [
      'MartinLogan (ficha oficial, martinlogan.com)',
      'Sound & Vision (HT Labs Measures) — impedancia mínima medida: 2,03 Ω a 17,2 kHz',
    ],
    pendiente: {
      es: 'ángulo de fase no publicado (esperable en un panel electrostático, cuya reactancia varía mucho con la frecuencia y no se resume bien en un solo ángulo); SPL máximo no publicado',
      en: 'phase angle not published (expected for an electrostatic panel, whose reactance varies heavily with frequency and does not summarize well into a single angle); maximum SPL not published',
    },
  },
  {
    id: 'wilson-audio-sabrina-v',
    marca: 'Wilson Audio',
    nombre: 'Wilson Audio Sabrina V',
    tipo: { es: 'Columna de 3 vías, alta gama estadounidense', en: '3-way floorstander, American high-end' },
    descripcion: {
      es: 'Columna de 3 vías de Wilson Audio (fabricante de Utah, EE.UU.), con tweeter de domo de seda de 25 mm, medio de 146 mm y woofer de 203 mm, todos de cono de pulpa de papel. La ficha oficial declara la sensibilidad explícitamente a 1 W, convención poco común en este catálogo (la mayoría declara 2,83 V).',
      en: "A 3-way floorstander from Wilson Audio (a Utah, USA manufacturer), with a 25 mm silk dome tweeter, a 146 mm midrange, and a 203 mm woofer, all paper-pulp cones. The official spec sheet explicitly declares sensitivity at 1 W, an uncommon convention in this catalog (most declare 2.83 V).",
    },
    sensibilidadDb: {
      valor: 87,
      fuente: { es: 'Wilson Audio (ficha oficial)', en: 'Wilson Audio (official spec sheet)' },
      confianza: 'alta',
      nota: { es: 'la ficha declara explícitamente "87 dB @ 1 Watt @ 1 meter @ 1 kHz"', en: 'the spec sheet explicitly states "87 dB @ 1 Watt @ 1 meter @ 1 kHz"' },
    },
    sensibilidadConvencion: '1W',
    impedanciaNominalOhm: 4,
    impedanciaMinOhm: 2.23,
    impedanciaMaxOhm: null,
    anguloFaseGrados: null,
    potenciaRecMinW: 50,
    potenciaRecMaxW: null,
    maxSplDb: null,
    chipsExtra: [{ es: 'mín. 2,23 Ω a 121 Hz (ficha oficial)', en: 'min. 2.23 Ω at 121 Hz (official spec sheet)' }],
    fuentes: ['Wilson Audio (ficha oficial, wilsonaudio.com)'],
    pendiente: {
      es: 'el fabricante no publica un techo de potencia recomendada (sólo el mínimo de 50 W), ni ángulo de fase ni SPL máximo',
      en: 'the manufacturer does not publish an upper bound for recommended power (only the 50 W minimum), nor a phase angle or maximum SPL',
    },
  },
  {
    id: 'paradigm-founder-40b',
    marca: 'Paradigm',
    nombre: 'Paradigm Founder 40B',
    tipo: { es: 'Monitor de estantería de 2 vías, bass reflex', en: '2-way bookshelf monitor, bass reflex' },
    descripcion: {
      es: 'Gama superior a la Premier 200B de este catálogo, misma marca. Paradigm mide su línea Founder con el NRC (National Research Council de Canadá); se revisó una medición independiente (Erin\'s Audio Corner) que no publicó un valor numérico de impedancia mínima en su reseña, así que ese campo se deja en null en vez de estimarlo del gráfico.',
      en: "A step above this catalog's Premier 200B, same brand. Paradigm measures its Founder line at the NRC (Canada's National Research Council); an independent measurement (Erin's Audio Corner) was reviewed but did not publish a numeric minimum-impedance value in its write-up, so that field is left null instead of eyeballing it off a graph.",
    },
    sensibilidadDb: {
      valor: 89,
      fuente: { es: 'Paradigm (ficha oficial)', en: 'Paradigm (official spec sheet)' },
      confianza: 'media',
      nota: {
        es: 'la ficha oficial da dos cifras, 89 dB anecoica y 92 dB "en sala" — se usa la anecoica, mismo criterio que el resto del catálogo',
        en: 'the official spec sheet gives two figures, 89 dB anechoic and 92 dB "in-room" — the anechoic one is used, same criterion as the rest of the catalog',
      },
    },
    sensibilidadConvencion: null,
    impedanciaNominalOhm: 8,
    ...
    potenciaRecMaxW: 150,
    maxSplDb: null,
    chipsExtra: [{ es: '92 dB en sala (cifra de marketing)', en: '92 dB in-room (marketing figure)' }],
    fuentes: ['Paradigm (ficha oficial, paradigm.com)', "Erin's Audio Corner (medición independiente, sin cifra numérica de impedancia mínima)"],
    pendiente: {
      es: 'impedancia mínima no publicada por el fabricante; la medición independiente revisada mostró un gráfico de impedancia sin un valor numérico citado en el texto de la reseña',
      en: "minimum impedance not published by the manufacturer; the independent measurement reviewed showed an impedance graph without a numeric value cited in the review's text",
    },
  },
  {
    id: 'psb-synchrony-b600',
    marca: 'PSB',
    nombre: 'PSB Synchrony B600',
    tipo: { es: 'Monitor de estantería de 2 vías, gama alta', en: '2-way bookshelf monitor, high-end' },
    descripcion: {
      es: 'Gama superior a la Alpha P5 de este catálogo, misma marca — tope de línea de estantería de PSB.',
      en: "A step above this catalog's Alpha P5, same brand — PSB's flagship bookshelf.",
    },
    sensibilidadDb: {
      valor: 86,
      fuente: { es: 'PSB Speakers (ficha oficial)', en: 'PSB Speakers (official spec sheet)' },
      confianza: 'media',
      nota: {
        es: 'la ficha oficial da dos cifras, 86 dB anecoica y 88 dB "en sala" — se usa la anecoica',
        en: 'the official spec sheet gives two figures, 86 dB anechoic and 88 dB "in-room" — the anechoic one is used',
      },
    },
    sensibilidadConvencion: null,
    impedanciaNominalOhm: 6,
    ...
    potenciaRecMaxW: 150,
    maxSplDb: null,
    chipsExtra: [{ es: '88 dB en sala (cifra de marketing)', en: '88 dB in-room (marketing figure)' }],
    fuentes: ['PSB Speakers (ficha oficial, psbspeakers.com)'],
  },
  {
    id: 'borresen-x3',
    marca: 'Børresen',
    nombre: 'Børresen X3',
    tipo: { es: 'Columna de 2,5 vías, tweeter de cinta plana', en: '2.5-way floorstander, planar ribbon tweeter' },
    descripcion: {
      es: 'Columna danesa de gama alta con tweeter de cinta plana propio y dos woofers de 11,4 cm. La ficha declara la sensibilidad explícitamente a 1 W.',
      en: 'A high-end Danish floorstander with a proprietary planar ribbon tweeter and two 11.4 cm woofers. The spec sheet explicitly declares sensitivity at 1 W.',
    },
    sensibilidadDb: {
      valor: 88,
      fuente: { es: 'Børresen (ficha oficial)', en: 'Børresen (official spec sheet)' },
      confianza: 'media',
      nota: {
        es: 'la ficha declara "88 dB/1W" — una fuente aislada dio una cifra distinta (89 dB a 6 Ω), no confirmada en el resto de las fuentes revisadas',
        en: 'the spec sheet states "88 dB/1W" — one isolated source gave a different figure (89 dB at 6 Ω), not confirmed by the rest of the sources reviewed',
      },
    },
    sensibilidadConvencion: '1W',
    impedanciaNominalOhm: 4,
    ...
    potenciaRecMaxW: null,
    maxSplDb: null,
    chipsExtra: [{ es: 'tweeter de cinta plana propio', en: 'proprietary planar ribbon tweeter' }],
    fuentes: ['Børresen (ficha oficial, distribuida por Highend Chile)'],
    pendiente: {
      es: 'impedancia mínima no encontrada publicada; no se pudo confirmar de forma independiente la discrepancia de una fuente que citaba 89 dB/6 Ω en vez de 88 dB/4 Ω',
      en: 'minimum impedance not found published; could not independently confirm the discrepancy from one source citing 89 dB/6 Ω instead of 88 dB/4 Ω',
    },
  },
  {
    id: 'magico-a3',
    marca: 'Magico',
    nombre: 'Magico A3',
    tipo: { es: 'Columna de 3 vías, gabinete de aluminio', en: '3-way floorstander, aluminum enclosure' },
    descripcion: {
      es: 'Columna estadounidense de gabinete de aluminio mecanizado — construcción muy rígida, característica de Magico. La ficha declara una impedancia mínima explícita ("no menos de 3,2 Ω"), sin especificar a qué frecuencia.',
      en: "An American floorstander with a machined-aluminum enclosure — a very rigid construction, characteristic of Magico. The spec sheet declares an explicit minimum impedance ('not less than 3.2 Ω'), without specifying at what frequency.",
    },
    sensibilidadDb: {
      valor: 88,
      fuente: { es: 'Magico (ficha oficial)', en: 'Magico (official spec sheet)' },
      confianza: 'media',
      nota: { es: 'convención de medición no declarada explícitamente', en: 'measurement convention not explicitly declared' },
    },
    sensibilidadConvencion: null,
    impedanciaNominalOhm: 4,
    impedanciaMinOhm: 3.2,
    ...
    potenciaRecMaxW: 300,
    maxSplDb: null,
    chipsExtra: [{ es: 'gabinete de aluminio mecanizado', en: 'machined-aluminum enclosure' }],
    fuentes: ['Magico (ficha oficial, magicoaudio.com)'],
    pendiente: {
      es: 'la ficha declara el mínimo de impedancia (3,2 Ω) sin indicar a qué frecuencia ocurre — se registra igual, es el único dato de mínimo disponible',
      en: 'the spec sheet declares the minimum impedance (3.2 Ω) without stating at what frequency it occurs — it is registered anyway, as the only minimum-impedance figure available',
    },
  },
  {
    id: 'magnat-signature-909',
    marca: 'Magnat',
    nombre: 'Magnat Signature 909',
    tipo: { es: 'Columna de 5 vías, alemana', en: '5-way German floorstander' },
    descripcion: {
      es: 'Columna alemana de 5 vías con impedancia nominal de 4 Ω que cae en dos zonas de la banda de audio — a 3,7 Ω hacia los 800 Hz y a 3,2 Ω hacia los 100 Hz, esta última la más exigente para un amplificador. Se registra el mínimo más bajo de las dos.',
      en: 'A German 5-way floorstander with a nominal impedance of 4 Ω that dips in two bands — to 3.7 Ω around 800 Hz and to 3.2 Ω around 100 Hz, the latter the more demanding one for an amplifier. The lower of the two minimums is registered.',
    },
    sensibilidadDb: {
      valor: 93,
      fuente: { es: 'Magnat (ficha oficial)', en: 'Magnat (official spec sheet)' },
      confianza: 'media',
      nota: { es: 'convención de medición no declarada explícitamente', en: 'measurement convention not explicitly declared' },
    },
    sensibilidadConvencion: null,
    ...
    potenciaRecMaxW: null,
    maxSplDb: null,
    chipsExtra: [{ es: 'mín. 3,7 Ω a 800 Hz y 3,2 Ω a 100 Hz (dos zonas)', en: 'min. 3.7 Ω at 800 Hz and 3.2 Ω at 100 Hz (two bands)' }],
    fuentes: ['Magnat (ficha oficial/manual de usuario)'],
    pendiente: {
      es: 'rango de potencia recomendada de amplificador no encontrado publicado',
      en: 'recommended amplifier power range not found published',
    },
  },
    ...
    },
{
  ...
  {
    id: 'anthem-str-integrated',
    marca: 'Anthem',
    nombre: 'Anthem STR Integrated',
    tipo: { es: 'Integrado Clase AB con DAC y corrección de sala ARC', en: 'Class AB integrated amplifier with DAC and ARC room correction' },
    descripcion: {
      es: '200 W en 8 Ω que suben a 400 W en 4 Ω (reserva 2×, por encima del umbral 1,7×) y hasta 550 W en 2 Ω — el fabricante publica una cifra continua incluso a esa carga, evidencia de que está diseñado para soportarla. 8 transistores de salida bipolares por canal y transformador toroidal de gran tamaño.',
      en: '200 W into 8 Ω rising to 400 W into 4 Ω (2x reserve, above the 1.7x threshold) and up to 550 W into 2 Ω — the manufacturer publishes a continuous figure even at that load, evidence that it is designed to sustain it. 8 bipolar output transistors per channel and a large toroidal transformer.',
    },
    potencia8OhmW: {
      valor: 200,
      fuente: { es: 'Anthem (ficha oficial, anthemav.com)', en: 'Anthem (official spec sheet, anthemav.com)' },
      confianza: 'alta',
    },
    potencia4OhmW: {
      valor: 400,
    ...
    sensEntradaMv: null,
    impedanciaEntradaOhm: null,
    factorAmortiguamiento: 360,
    chipsExtra: [
      { es: 'Anthem Room Correction (ARC Genesis)', en: 'Anthem Room Correction (ARC Genesis)' },
      { es: '550 W continuos a 2 Ω', en: '550 W continuous into 2 Ω' },
    ],
    fuentes: ['Anthem (ficha oficial, anthemav.com)'],
    pendiente: {
      es: 'sensibilidad e impedancia de entrada de línea no encontradas publicadas',
      en: 'line input sensitivity and impedance not found published',
    },
  },
  {
    id: 'lyngdorf-tdai-3400',
    marca: 'Lyngdorf',
    nombre: 'Lyngdorf TDAI-3400',
    tipo: { es: 'Integrado Clase D (Equibit) con DAC, streaming y DSP de sala', en: 'Class D (Equibit) integrated amplifier with DAC, streaming, and room DSP' },
    descripcion: {
      es: '200 W en 8 Ω que suben a 400 W en 4 Ω (reserva exacta 2×) — Lyngdorf logra este doblado de potencia con su tecnología propia Equibit (conmutación MOSFET de baja Rds), hasta 40 A de corriente máxima. Como en todo diseño Clase D moderno de este tipo, no publica un factor de amortiguamiento en el sentido clásico (la etapa de salida ya integra su propia realimentación/control digital) — se deja en null en vez de inventar una cifra.',
      en: "200 W into 8 Ω rising to 400 W into 4 Ω (an exact 2x reserve) — Lyngdorf achieves this power doubling with its proprietary Equibit technology (low-Rds MOSFET switching), up to 40 A of peak current. As with most modern Class D designs of this kind, it does not publish a damping factor in the classic sense (the output stage already integrates its own digital feedback/control) — left null instead of inventing a figure.",
    },
    potencia8OhmW: {
      valor: 200,
      fuente: { es: 'Lyngdorf (ficha oficial, reproducida por distribuidores y reseñas técnicas)', en: 'Lyngdorf (official spec sheet, reproduced by dealers and technical reviews)' },
      confianza: 'alta',
    },
    potencia4OhmW: {
      valor: 400,
    ...
    factorAmortiguamiento: null,
    chipsExtra: [
      { es: 'DSP RoomPerfect (corrección de sala)', en: 'RoomPerfect DSP (room correction)' },
      { es: 'Equibit Clase D, hasta 40 A', en: 'Equibit Class D, up to 40 A' },
    ],
    fuentes: ['SoundStage! Hi-Fi, The Ear, Audioholics (reseñas técnicas que reproducen la ficha del fabricante)'],
    pendiente: {
      es: 'no se pudo acceder directamente a una ficha oficial en steinwaylyngdorf.com (bloqueada) — la potencia se confirma de forma consistente en tres reseñas técnicas independientes que citan la misma cifra; carga mínima, sensibilidad e impedancia de entrada, y factor de amortiguamiento no se encontraron publicados en ninguna',
      en: 'could not directly access an official spec sheet on steinwaylyngdorf.com (blocked) — power is confirmed consistently across three independent technical reviews citing the same figure; minimum load, input sensitivity/impedance, and damping factor were not found published in any of them',
    },
  },
  {
    id: 'primare-i25-prisma',
    marca: 'Primare',
    nombre: 'Primare I25 Prisma',
    tipo: { es: 'Integrado Clase D (UFPD 2) modular, con streamer de red', en: 'Modular Class D (UFPD 2) integrated amplifier, with network streamer' },
    descripcion: {
      es: '100 W en 8 Ω que suben a 200 W en 4 Ω (reserva exacta 2×). Usa el módulo de amplificación Clase D propio de Primare (UFPD 2) — como otros diseños Clase D de este catálogo, no publica un factor de amortiguamiento clásico ni sensibilidad/impedancia de entrada de línea en su documentación pública.',
      en: "100 W into 8 Ω rising to 200 W into 4 Ω (an exact 2x reserve). Uses Primare's own Class D amplification module (UFPD 2) — like other Class D designs in this catalog, it does not publish a classic damping factor or line input sensitivity/impedance in its public documentation.",
    },
    potencia8OhmW: {
      valor: 100,
      fuente: { es: 'Primare (ficha oficial, primare.net)', en: 'Primare (official spec sheet, primare.net)' },
      confianza: 'alta',
    },
    potencia4OhmW: {
      valor: 200,
    ...
    factorAmortiguamiento: null,
    chipsExtra: [
      { es: 'módulo UFPD 2 (Clase D)', en: 'UFPD 2 module (Class D)' },
      { es: 'streamer Prisma integrado', en: 'built-in Prisma streamer' },
    ],
    fuentes: ['Primare (ficha oficial, primare.net)'],
    pendiente: {
      es: 'carga mínima, sensibilidad e impedancia de entrada, y factor de amortiguamiento no publicados en la ficha oficial revisada — común en amplificadores Clase D, cuya etapa de salida no se caracteriza igual que un diseño Clase AB/B',
      en: 'minimum load, input sensitivity/impedance, and damping factor not published in the official spec sheet reviewed — common in Class D amplifiers, whose output stage is not characterized the same way as a Class AB/B design',
    },
  },
  {
    id: 'technics-su-g700m2',
    marca: 'Technics',
    nombre: 'Technics SU-G700M2',
    tipo: { es: 'Integrado digital JENO Engine, con DAC y phono MM/MC', en: 'JENO Engine digital integrated amplifier, with DAC and MM/MC phono' },
    descripcion: {
      es: '70 W en 8 Ω que suben a 140 W en 4 Ω (reserva exacta 2×, medidos a 0,5 % THD). Amplificación digital JENO Engine con GaN FET y LAPC (Load Adaptive Phase Calibration) — Technics declara que este diseño tiene un factor de amortiguamiento alto en graves pero bajo en agudos, sin dar una cifra única resumida; se deja factorAmortiguamiento en null en vez de forzar un solo número que no represente bien ese comportamiento dependiente de la frecuencia.',
      en: "70 W into 8 Ω rising to 140 W into 4 Ω (an exact 2x reserve, measured at 0.5% THD). JENO Engine digital amplification with GaN FETs and LAPC (Load Adaptive Phase Calibration) — Technics states that this design has a high damping factor at low frequencies but a low one at high frequencies, without giving one summarized figure; factorAmortiguamiento is left null instead of forcing a single number that would not represent that frequency-dependent behavior well.",
    },
    potencia8OhmW: {
      valor: 70,
      fuente: { es: 'Technics (ficha oficial)', en: 'Technics (official spec sheet)' },
      confianza: 'alta',
      nota: { es: 'medida a 0,5 % THD', en: 'measured at 0.5% THD' },
    },
    potencia4OhmW: {
      valor: 140,
      fuente: { es: 'Technics (ficha oficial)', en: 'Technics (official spec sheet)' },
    ...
    factorAmortiguamiento: null,
    chipsExtra: [
      { es: 'JENO Engine (GaN FET)', en: 'JENO Engine (GaN FET)' },
      { es: 'LAPC (calibración de fase por carga)', en: 'LAPC (load-adaptive phase calibration)' },
      { es: 'phono MM/MC', en: 'MM/MC phono' },
    ],
    fuentes: ['Technics (ficha oficial, reproducida por Music Direct y Value Electronics)'],
    pendiente: {
      es: 'factor de amortiguamiento declarado como dependiente de la frecuencia (alto en graves, bajo en agudos) sin una cifra única — se deja en null en vez de resumir mal ese comportamiento; carga mínima no encontrada publicada',
      en: 'damping factor declared as frequency-dependent (high at low frequencies, low at high ones) without one summarized figure — left null instead of poorly summarizing that behavior; minimum load not found published',
    },
  },
  {
    id: 'anthem-mrx-740-8k',
    marca: 'Anthem',
    nombre: 'Anthem MRX 740 8K',
    tipo: { es: 'Receptor AV multicanal (11 pre + 2 subwoofer, 7 canales de ampli)', en: 'Multichannel AV receiver (11.2 pre-outs, 7 amplified channels)' },
    descripcion: {
      es: 'Receptor AV, no un integrado estéreo dedicado — mismo tratamiento que ya recibe el Marantz SR6008 de este catálogo: se registra el rating con **2 canales excitados** (140 W/8 Ω), no una cifra de 1 canal que infle el marketing. Con más de 2 canales activos a la vez, Anthem publica un rating menor (60 W/8 Ω para los canales restantes). No se encontró una cifra de potencia continua a 4 Ω, aunque el fabricante declara el receptor compatible con esa carga.',
      en: "An AV receiver, not a dedicated stereo integrated — same treatment already applied to this catalog's Marantz SR6008: the rating with **2 channels driven** (140 W/8 Ω) is registered, not a single-channel figure that inflates marketing. With more than 2 channels active at once, Anthem publishes a lower rating (60 W/8 Ω for the remaining channels). No continuous 4 Ω power figure was found, though the manufacturer declares the receiver compatible with that load.",
    },
    potencia8OhmW: {
      valor: 140,
      fuente: { es: 'Anthem (ficha oficial, anthemav.com)', en: 'Anthem (official spec sheet, anthemav.com)' },
      confianza: 'media',
      nota: {
        es: 'rating con 2 de los 7 canales excitados a la vez — con más canales activos, Anthem publica 60 W/8 Ω para el resto',
        en: 'rating with 2 of the 7 channels driven at once — with more channels active, Anthem publishes 60 W/8 Ω for the rest',
      },
    },
    potencia4OhmW: null,
    cargaMinOhm: 4,
    ...
    chipsExtra: [
      { es: 'Anthem Room Correction (ARC Genesis)', en: 'Anthem Room Correction (ARC Genesis)' },
      { es: '11 pre-salidas + 2 subwoofer, 7 canales amplificados', en: '11.2 pre-outs, 7 amplified channels' },
    ],
    fuentes: ['Anthem (ficha oficial, anthemav.com)', 'Audioholics (banco de pruebas independiente)'],
    pendiente: {
      es: 'sin cifra de potencia continua a 4 Ω publicada — el fabricante sólo declara "compatible" con esa carga sin dar vatios; cargaMinOhm=4 se registra por esa declaración de compatibilidad, no por un rating numérico. Sensibilidad e impedancia de entrada de línea tampoco publicadas',
      en: 'no continuous 4 Ω power figure published — the manufacturer only states it is "compatible" with that load without giving a wattage; cargaMinOhm=4 is registered from that compatibility statement, not from a numeric rating. Line input sensitivity and impedance are not published either',
    },
  },
  {
    id: 'bryston-4b3',
    marca: 'Bryston',
    nombre: 'Bryston 4B³ Cubed',
    tipo: { es: 'Amplificador de potencia sin previo, Clase AB', en: 'Power amplifier without preamp, Class AB' },
    descripcion: {
      es: 'Amplificador de potencia puro (necesita un previo aparte) — mismo tratamiento de categoría que el Hegel H30A ya catalogado. 300 W en 8 Ω que suben a 500 W en 4 Ω (reserva 1,67×, justo debajo del umbral 1,7×). Puede puentearse a mono para entregar 900 W en 8 Ω.',
      en: "A pure power amplifier (needs a separate preamp) — same category treatment as this catalog's already-cataloged Hegel H30A. 300 W into 8 Ω rising to 500 W into 4 Ω (1.67x reserve, just under the 1.7x threshold). Can be bridged to mono for 900 W into 8 Ω.",
    },
    potencia8OhmW: {
      valor: 300,
      fuente: { es: 'Bryston (ficha oficial/manual)', en: "Bryston (official spec sheet/manual)" },
      confianza: 'alta',
    },
    potencia4OhmW: {
      valor: 500,
    ...
    cargaMinOhm: null,
    sensEntradaMv: 1700,
    impedanciaEntradaOhm: 7500,
    factorAmortiguamiento: 500,
    chipsExtra: [
      { es: 'puenteable a mono (900 W/8 Ω)', en: 'bridgeable to mono (900 W/8 Ω)' },
      { es: 'entrada balanceada 30 kΩ+', en: 'balanced input 30 kΩ+' },
    ],
    fuentes: ['Bryston (ficha oficial/manual, reproducida por HiFi Engine y reseñas técnicas)'],
    pendiente: {
      es: 'impedancia de entrada registrada es la no balanceada (7,5 kΩ) — la balanceada es mayor (30 kΩ+); carga mínima soportada no encontrada publicada',
      en: 'the registered input impedance is the unbalanced one (7.5 kΩ) — the balanced one is higher (30 kΩ+); minimum supported load not found published',
    },
  },
  {
    id: 'rotel-a11mkii',
    marca: 'Rotel',
    nombre: 'Rotel A11MKII',
    tipo: { es: 'Integrado Clase AB de entrada, con DAC', en: 'Entry-level Class AB integrated amplifier, with DAC' },
    descripcion: {
      es: 'Escalón de entrada de Rotel, debajo del A14MKII ya catalogado — 50 W en 8 Ω que suben a 62 W en 4 Ω (reserva 1,24×, muy por debajo del umbral 1,7×, esperable en un integrado de entrada con transformador más modesto).',
      en: "Rotel's entry point, a step below this catalog's already-cataloged A14MKII — 50 W into 8 Ω rising to 62 W into 4 Ω (1.24x reserve, well below the 1.7x threshold, expected for an entry-level integrated with a more modest transformer).",
    },
    potencia8OhmW: {
      valor: 50,
      fuente: { es: 'Rotel (ficha oficial, rotel.com)', en: 'Rotel (official spec sheet, rotel.com)' },
      confianza: 'media',
      nota: {
        es: 'la ficha oficial también muestra una cifra de 62 W/8 Ω bajo una etiqueta distinta ("FTC") cuya condición exacta no quedó clara al revisarla — se usa la de 50 W, consistente con la mayoría de las fuentes revisadas',
        en: 'the official spec sheet also shows a 62 W/8Ω figure under a different label ("FTC") whose exact test condition was not clear on review — the 50 W figure is used, consistent with most sources reviewed',
      },
    },
    potencia4OhmW: {
      valor: 62,
    ...
    cargaMinOhm: null,
    sensEntradaMv: 130,
    impedanciaEntradaOhm: 45000,
    factorAmortiguamiento: 120,
    chipsExtra: [{ es: 'DAC integrado', en: 'Built-in DAC' }],
    fuentes: ['Rotel (ficha oficial, rotel.com)', 'Music Direct (confirma 50 W/8 Ω y 62 W/4 Ω sin ambigüedad de etiqueta)'],
    pendiente: {
      es: 'la ficha oficial de rotel.com muestra una tercera cifra ("FTC (8 Ω): 62 W") cuya condición de medición no se pudo determinar con certeza — se optó por la lectura consistente con la mayoría de las fuentes (50 W/8 Ω, 62 W/4 Ω) en vez de arriesgar una interpretación errónea',
      en: 'the official rotel.com spec sheet shows a third figure ("FTC (8 Ω): 62 W") whose measurement condition could not be determined with certainty — the reading consistent with most sources (50 W/8 Ω, 62 W/4 Ω) was chosen instead of risking a wrong interpretation',
    },
  },
  {
    id: 'line-magnetic-lm-518ia',
    marca: 'Line Magnetic',
    nombre: 'Line Magnetic LM-518IA',
    tipo: { es: 'Integrado a válvulas SET (845), Clase A pura', en: 'SET (845) tube integrated amplifier, pure Class A' },
    descripcion: {
      es: 'Integrado chino a válvulas de triodo de simple terminación (SET, 845 de salida, Clase A pura) — sólo 22 W en 8 Ω, mucho menos que cualquier diseño de estado sólido de este catálogo, típico de un SET. El transformador de salida tiene tomas conmutables para 4/8/16 Ω: no es que "gane" potencia a cargas más bajas como un ampli de estado sólido, sino que la toma se elige para adaptar la impedancia del parlante — por eso no se registra una potencia a 4 Ω, sería una comparación sin sentido físico para este diseño.',
      en: "A Chinese single-ended triode (SET) tube integrated amplifier (845 output tubes, pure Class A) — only 22 W into 8 Ω, far less than any solid-state design in this catalog, typical of a SET. The output transformer has switchable taps for 4/8/16 Ω: it doesn't 'gain' power into lower loads the way a solid-state amp does — the tap is chosen to match the speaker's impedance instead — so a 4 Ω power figure is not registered, as it would be a physically meaningless comparison for this design.",
    },
    potencia8OhmW: {
      valor: 22,
      fuente: { es: 'Line Magnetic (ficha oficial/manual)', en: 'Line Magnetic (official spec sheet/manual)' },
      confianza: 'alta',
    },
    potencia4OhmW: null,
    cargaMinOhm: null,
    ...
    factorAmortiguamiento: null,
    chipsExtra: [
      { es: 'SET 845, Clase A pura', en: 'SET 845, pure Class A' },
      { es: 'tomas de salida 4/8/16 Ω', en: '4/8/16 Ω output taps' },
    ],
    fuentes: ['Line Magnetic (ficha oficial/manual, reproducida por HiFi Engine y distribuidores)'],
    pendiente: {
      es: 'potencia a 4 Ω se deja en null a propósito — el transformador de salida tiene tomas conmutables en vez de escalar potencia con la carga, así que "potencia a 4 Ω" no es una pregunta que este diseño responda de la misma forma que un amplificador de estado sólido. Factor de amortiguamiento no publicado (característicamente muy bajo en diseños SET sin realimentación global, pero no se registra una cifra sin una fuente que la mida)',
      en: '4 Ω power is left null on purpose — the output transformer has switchable taps instead of scaling power with the load, so "power into 4 Ω" is not a question this design answers the same way a solid-state amplifier does. Damping factor not published (characteristically very low in SET designs without global feedback, but no figure is registered without a source measuring it)',
    },
  },
  {
    id: 'nagra-classic-amp',
    marca: 'Nagra',
    nombre: 'Nagra Classic AMP',
    tipo: { es: 'Integrado/etapa de potencia suizo, puenteable a mono', en: 'Swiss integrated/power stage, bridgeable to mono' },
    descripcion: {
      es: '100 W en 8 Ω en modo estéreo — Nagra sólo publica una cifra a 4 Ω para el modo puenteado a mono (200 W), no comparable 1:1 con la cifra estéreo de 8 Ω, así que potencia4OhmW se deja en null en vez de usar una cifra de una configuración distinta. Sensibilidad de entrada conmutable entre 1 V y 2 V.',
      en: '100 W into 8 Ω in stereo mode — Nagra only publishes a 4 Ω figure for the mono-bridged mode (200 W), not directly comparable to the 8 Ω stereo figure, so potencia4OhmW is left null instead of using a figure from a different configuration. Switchable input sensitivity between 1V and 2V.',
    },
    potencia8OhmW: {
      valor: 100,
      fuente: { es: 'Nagra (ficha oficial, nagraaudio.com)', en: 'Nagra (official spec sheet, nagraaudio.com)' },
      confianza: 'alta',
    },
    potencia4OhmW: null,
    cargaMinOhm: null,
    ...
    factorAmortiguamiento: null,
    chipsExtra: [
      { es: 'puenteable a mono (200 W/4 Ω)', en: 'bridgeable to mono (200 W/4 Ω)' },
      { es: 'sensibilidad conmutable 1 V/2 V', en: 'switchable 1V/2V sensitivity' },
      { es: 'Clase A extendida', en: 'extended Class A' },
    ],
    fuentes: ['Nagra (ficha oficial, nagraaudio.com)'],
    pendiente: {
      es: 'potencia estéreo a 4 Ω no publicada — sólo existe la cifra puenteada a mono (200 W/4 Ω), una configuración distinta, no usada acá para no comparar peras con manzanas. Impedancia de entrada declarada como ">100 kΩ", sin cifra exacta — se registra 100 kΩ como piso conservador de esa cota. Factor de amortiguamiento no publicado',
      en: 'stereo 4 Ω power not published — only the mono-bridged figure exists (200 W/4 Ω), a different configuration, not used here to avoid comparing apples to oranges. Input impedance declared as ">100 kΩ", without an exact figure — 100 kΩ is registered as the conservative floor of that bound. Damping factor not published',
    },
  },
  {
    id: 'onkyo-a9110',
    marca: 'Onkyo',
    nombre: 'Onkyo A-9110',
    tipo: { es: 'Integrado Clase AB de entrada, con phono MM', en: 'Entry-level Class AB integrated amplifier, with MM phono' },
    descripcion: {
      es: 'Integrado compacto japonés de entrada — 30 W en 8 Ω que suben a 50 W en 4 Ω. La ficha oficial confirma la compatibilidad de carga entre 4 y 16 Ω y un factor de amortiguamiento de 95 (a 1 kHz/8 Ω).',
      en: "A compact, entry-level Japanese integrated amplifier — 30 W into 8 Ω rising to 50 W into 4 Ω. The official spec sheet confirms load compatibility between 4 and 16 Ω and a damping factor of 95 (at 1 kHz/8 Ω).",
    },
    potencia8OhmW: {
      valor: 30,
      fuente: { es: 'Onkyo (ficha oficial, reproducida por reseñas técnicas)', en: 'Onkyo (official spec sheet, reproduced by technical reviews)' },
      confianza: 'media',
      nota: {
        es: 'medida a 0,7 % THD; esta cifra específica no se pudo confirmar directo en la página revisada de onkyo.com, que sólo mostraba la de 4 Ω',
        en: 'measured at 0.7% THD; this specific figure could not be confirmed directly on the onkyo.com page reviewed, which only showed the 4 Ω one',
      },
    },
    potencia4OhmW: {
      valor: 50,
      fuente: { es: 'Onkyo (ficha oficial, onkyo.com)', en: 'Onkyo (official spec sheet, onkyo.com)' },
      confianza: 'alta',
      nota: { es: 'medida a 0,9 % THD', en: 'measured at 0.9% THD' },
    },
    cargaMinOhm: 4,
    sensEntradaMv: 200,
    impedanciaEntradaOhm: 47000,
    factorAmortiguamiento: 95,
    chipsExtra: [{ es: 'phono MM', en: 'MM phono' }],
    fuentes: ['Onkyo (ficha oficial, onkyo.com)'],
    pendiente: {
      es: 'la cifra de 8 Ω (30 W) viene de reseñas técnicas que reproducen la ficha del fabricante, no confirmada directo en la página de onkyo.com consultada (que sólo mostraba la de 4 Ω) — confianza degradada a media por eso',
      en: 'the 8 Ω figure (30 W) comes from technical reviews reproducing the manufacturer spec sheet, not directly confirmed on the onkyo.com page consulted (which only showed the 4 Ω one) — confidence downgraded to medium because of that',
    },
  },
  ...
  streamers: [
    ...
    },
    {
      ...
      nombre: 'Aurender A10',
      tipo: {
        es: 'Streamer de red, DAC dual-mono integrado, salida RCA y XLR',
        en: 'Network streamer, dual-mono integrated DAC, RCA and XLR output',
      },
      descripcion: {
        es: 'A diferencia del N200 ya catalogado (transporte puro), el A10 sí tiene DAC integrado (AK4490 dual-mono) y salida analógica: 2 V en RCA, 4 V en XLR. Stereophile midió una impedancia de salida extremadamente baja, "1 Ω o menos" en todo el rango de audio — se registra 1 Ω como techo conservador de esa medición.',
        en: "Unlike this catalog's already-cataloged N200 (a pure transport), the A10 does have a built-in DAC (dual-mono AK4490) and an analog output: 2V on RCA, 4V on XLR. Stereophile measured an extremely low output impedance, '1 Ω or less' across the entire audio range — 1 Ω is registered as the conservative ceiling of that measurement.",
      },
      salidaV: 2,
      impedanciaSalidaOhm: 1,
      fuente: { es: 'Aurender (ficha oficial) + Stereophile (medición independiente)', en: 'Aurender (official spec sheet) + Stereophile (independent measurement)' },
      confianza: 'alta',
      chipsExtra: [
        { es: 'DAC dual-mono AK4490', en: 'dual-mono AK4490 DAC' },
        { es: 'XLR balanceada 4 V', en: 'balanced XLR 4V' },
      ],
      fuentes: [
        'Aurender (ficha oficial, aurenderamerica.com)',
        'Stereophile (Measurements) — impedancia de salida "1 Ω o menos" en todo el rango de audio',
      ],
    },
    {
    ...
    },
    {
      id: 'eversolo-dmp-a8',
      marca: 'Eversolo',
      nombre: 'Eversolo DMP-A8',
      tipo: {
        es: 'Streamer de red, DAC integrado, salida RCA y XLR variable',
        en: 'Network streamer, integrated DAC, variable RCA and XLR output',
      },
      descripcion: {
        es: 'Tope de línea de Eversolo, sobre el DMP-A6 ya catalogado. Salida totalmente variable: 2,1 V / 51 Ω en RCA, 4,2 V / 101 Ω en XLR — se registra la cifra RCA, más comparable con el resto del catálogo.',
        en: "Eversolo's flagship, above this catalog's already-cataloged DMP-A6. Fully variable output: 2.1V / 51 Ω on RCA, 4.2V / 101 Ω on XLR — the RCA figure is registered here, more comparable to the rest of the catalog.",
      },
      salidaV: 2.1,
      impedanciaSalidaOhm: 51,
      fuente: { es: 'Eversolo (ficha oficial) + Stereophile (medición independiente)', en: 'Eversolo (official spec sheet) + Stereophile (independent measurement)' },
      confianza: 'alta',
      chipsExtra: [
        { es: 'XLR balanceada 4,2 V / 101 Ω', en: 'balanced XLR 4.2 V / 101 Ω' },
        { es: 'salida totalmente variable', en: 'fully variable output' },
      ],
      fuentes: [
        'Eversolo (ficha oficial, música.eversolo.com — manual de usuario)',
        'Stereophile (Measurements) — impedancia de salida: 51 Ω (RCA) / 101 Ω (XLR)',
      ],
    },
  ],
    ...
    },
{
  ...
  },
  {
    ...
    marca: 'dCS',
    nombre: 'dCS Bartók',
    tipo: { es: 'DAC/previo con amplificador de audífonos, salida RCA y XLR configurable', en: 'DAC/preamp with headphone amplifier, configurable RCA and XLR output' },
    descripcion: {
      es: 'DAC insignia británico con amplificador de audífonos integrado. La salida es configurable por menú en 4 niveles (0,2 / 0,6 / 2 / 6 V) para escala completa — se registra el máximo (6 V), mismo criterio que otros equipos de este catálogo con salida ajustable. La impedancia de salida difiere fuerte entre conectores: 52 Ω en RCA no balanceada, apenas 3 Ω en XLR balanceada.',
      en: 'A flagship British DAC with a built-in headphone amplifier. Output is menu-configurable across 4 levels (0.2 / 0.6 / 2 / 6 V) for full scale — the maximum (6 V) is registered here, the same criterion applied to other adjustable-output units in this catalog. Output impedance differs sharply between connectors: 52 Ω on unbalanced RCA, just 3 Ω on balanced XLR.',
    },
    salidaV: 6,
    impedanciaSalidaOhm: 52,
    fuente: { es: 'dCS (manual oficial)', en: 'dCS (official manual)' },
    confianza: 'alta',
    chipsExtra: [
      { es: 'XLR balanceada 6 V / 3 Ω', en: 'balanced XLR 6 V / 3 Ω' },
      { es: 'salida en 4 niveles (0,2/0,6/2/6 V)', en: '4-level output (0.2/0.6/2/6V)' },
      { es: 'amplificador de audífonos integrado', en: 'built-in headphone amplifier' },
    ],
    fuentes: ['dCS (manual oficial) — "Output levels: 0.2, 0.6, 2V or 6V rms"; "Output impedance is 3Ω" (XLR) / "52Ω" (RCA)'],
    pendiente: {
      es: 'se registra la impedancia de salida RCA (52 Ω), más comparable con el resto del catálogo — la XLR (3 Ω) queda declarada en chipsExtra, no descartada',
      en: 'the RCA output impedance (52 Ω) is registered, more comparable with the rest of the catalog — the XLR one (3 Ω) is declared in chipsExtra, not discarded',
    },
  },
  {
    id: 'dcs-lina-dac',
    marca: 'dCS',
    nombre: 'dCS Lina DAC',
    tipo: { es: 'DAC de red, salida RCA y XLR configurable', en: 'Network DAC, configurable RCA and XLR output' },
    descripcion: {
      es: 'Escalón de entrada a la gama dCS, debajo del Bartók ya catalogado — comparte la misma etapa de salida: 4 niveles configurables (0,2/0,6/2/6 V) y las mismas impedancias, 52 Ω en RCA y 3 Ω en XLR. Se registra el máximo (6 V) y la RCA (52 Ω), mismo criterio que el Bartók.',
      en: "dCS's entry point, a step below this catalog's already-cataloged Bartók — it shares the same output stage: 4 configurable levels (0.2/0.6/2/6V) and the same impedances, 52 Ω on RCA and 3 Ω on XLR. The maximum (6V) and RCA (52 Ω) are registered, same criterion as the Bartók.",
    },
    salidaV: 6,
    impedanciaSalidaOhm: 52,
    fuente: { es: 'dCS (manual oficial)', en: 'dCS (official manual)' },
